...
export const DIALBuildingBlockContext = createContext<IDIALBuildingBlockContext>({
...
export const DIALBuildingBlockContextProvider = ({
  ...
  const [openedBuildingBlock, setOpenedBuildingBlock] = useState<BUILDING_BLOCK | null>(null);
  return (
